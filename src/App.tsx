...
import OrganizationProfilePage from "./pages/admin/OrganizationProfilePage"; // New import
        ...
        <SessionContextProvider>
          <DashboardLayoutProvider>
            <Routes>
              ...
              <Route path="/admin/organization-profile" element={<OrganizationProfilePage />} /> {/* New Route */}
